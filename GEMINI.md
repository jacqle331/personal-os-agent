# Personal Agent OS — Instructions (Gemini CLI)

> This file mirrors `.github/copilot-instructions.md` and `CLAUDE.md` so the same
> agent works in Gemini CLI, GitHub Copilot, or Claude Code. If you change one,
